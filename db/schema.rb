...
ActiveRecord::Schema.define(version: 20140120005957) do
  ...
  add_index "geoname", ["geonameid", "name"], name: "geonamename_idx", unique: true, using: :btree
  add_index "geoname", ["geonameid"], name: "geonameid_idx", unique: true, using: :btree
  ...
  add_index "geoname_hierarchy", ["geoname_id", "hierarchy_tree"], name: "geonamehierarchy_tree_idx", unique: true, using: :btree
  add_index "geoname_hierarchy", ["geoname_id"], name: "geonamehierarchy_geonameid_idx", using: :btree
  ...
  add_index "geoname_search", ["geo_location"], name: "entries_by_geo_location", using: :btree
  add_index "geoname_search", ["geoname_id", "object_id"], name: "entries_by_geoname_id_and_object_id", unique: true, using: :btree
  ...
  add_index "mesh_tree_structures", ["subject_mesh_term_id", "tree_structure"], name: "entries_by_term_id_and_tree_structure", unique: true, using: :btree
  add_index "mesh_tree_structures", ["tree_structure"], name: "entries_by_tree_structure", using: :btree
  ...
  add_index "species_taxon_entries", ["species_taxon_id", "facet_tree_term"], name: "entries_by_id_and_tree_term", unique: true, using: :btree
  add_index "species_taxon_entries", ["species_taxon_id", "term"], name: "entries_by_species_id_and_term", unique: true, using: :btree
  add_index "species_taxon_entries", ["species_taxon_id", "term_synonyms"], name: "entries_by_species_id_and_synonyms", unique: true, using: :btree
  add_index "species_taxon_entries", ["species_taxon_id"], name: "entries_by_species_id", unique: true, using: :btree
  ...
  add_index "subject_local_authority_entries", ["lower_label"], name: "entries_by_lower_label", using: :btree
  ...
  add_index "subject_mesh_entries", ["subject_mesh_term_id", "term"], name: "entries_by_id_and_term", unique: true, using: :btree
  add_index "subject_mesh_entries", ["subject_mesh_term_id"], name: "entries_by_subject_mesh_term_id", using: :btree
  ...
  add_index "subject_mesh_synonyms", ["subject_mesh_term_id", "subject_synonym"], name: "entries_by_id_and_synonyms", unique: true, using: :btree
